...
@interface SUWebViewController1 ()
/// webView
...
/// viewModel
@property (nonatomic, strong, readonly) SUWebViewModel1 *viewModel;

@end

@implementation SUWebViewController1
{
    /// KVOController 监听数据
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSURL *url;
    if ([self.viewModel.request isKindOfClass:[NSURL class]]) {
        url = (NSURL *)self.viewModel.request;
    } else {
        url = [NSURL URLWithString:self.viewModel.request];
    }
