...
- (void)_thumbBtnDidClicked:(UIButton *)sender
{
    MHLog(@"---zan---");
    sender.enabled = NO;
//    self.videoTopicFrame.videoTopic.zan = YES;
    
//    if (self.delegate && [self.delegate respondsToSelector:@selector(videoTopicHeaderViewForClickedZanAction:)]) {
//        [self.delegate videoTopicHeaderViewForClickedZanAction:self];
//    }
...
{
    MHLog(@"---more---");
//    if (self.delegate && [self.delegate respondsToSelector:@selector(videoTopicHeaderViewForClickedMoreAction:)]) {
//        [self.delegate videoTopicHeaderViewForClickedMoreAction:self];
//    }
}

- (void)_avatarOrNicknameDidClicked
{
//    if (self.delegate && [self.delegate respondsToSelector:@selector(videoTopicHeaderViewForClickedAvatarOrNicknameAction:)]) {
//        [self.delegate videoTopicHeaderViewForClickedAvatarOrNicknameAction:self];
//    }
}
...
{
    MHLog(@"---文本内容---");
//    if (self.delegate && [self.delegate respondsToSelector:@selector(videoTopicHeaderViewForClickedContentTextAction:)]) {
//        [self.delegate videoTopicHeaderViewForClickedContentTextAction:self];
//    }
}
