//
//  MHHorizontalMode1LayoutController.m
//  MHObjectiveC
//
//  Created by CoderMikeHe on 2018/12/14.
//  Copyright © 2018年 CoderMikeHe. All rights reserved.
//  方案二 ： 1个黑块 == 1个Cell，自定义MHCollectionViewHorizontalFlowLayout布局，且UIPageControl不支持联动

#import "MHHorizontalMode1LayoutController.h"
...
@interface MHHorizontalMode1LayoutController ()<UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate,MHHorizontalCellDelegate>
/// backgroundView
...
@implementation MHHorizontalMode1LayoutController
...
- (void)_configureData{
    ...
    for (NSInteger g = 0 ; g < groupCount ; g++) {
        ...
        /// 加入数据源
        [self.dataSource addObject:group.horizontals];
    }
    /// 赋值
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.horizontal = tempArray[indexPath.item];
    cell.delegate = self;
    return cell;
}
...
- (void)collectionViewCellTapAction:(UICollectionViewCell *)cell{
    ...
    MHHorizontal *horizontal = tempArr[indexPath.item];
...
- (void)_setupPageControl{
    ...
    pageControl.userInteractionEnabled = NO; /// 不要接收事件
