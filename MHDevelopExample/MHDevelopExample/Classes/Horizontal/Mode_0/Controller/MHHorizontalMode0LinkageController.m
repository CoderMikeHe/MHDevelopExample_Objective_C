//
//  MHHorizontalMode0LinkageController.m
//  MHObjectiveC
//
//  Created by CoderMikeHe on 2018/12/14.
//  Copyright © 2018年 CoderMikeHe. All rights reserved.
//  方案一情况下的： PageControl 联动实现
/// 原理：采用UIScrollView实现。<PS：当然也可以使用 UICollectionView实现，没毛病，但是比较大材小用，嘻嘻嘻>

#import "MHHorizontalMode0LinkageController.h"
...
@interface MHHorizontalMode0LinkageController ()<UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate,MHHorizontalCellDelegate>
/// backgroundView
...
@implementation MHHorizontalMode0LinkageController
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    NSArray *groupArr = self.dataSource[section];
    return groupArr.count;
}

- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MHHorizontalMode0Cell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass(MHHorizontalMode0Cell.class) forIndexPath:indexPath];
    cell.horizontals = self.dataSource[indexPath.section][indexPath.item];
    cell.delegate = self;
    return cell;
}
...
- (void)collectionViewCellTapAction:(UICollectionViewCell *)cell selectedIndex:(NSInteger)selectedIndex{
    ...
    NSArray *horizontals = self.dataSource[indexPath.section][indexPath.item];
    MHHorizontal *horizontal = horizontals[selectedIndex];
...
- (void)_setupContentView{
    ...
    /// 注册CellID
    [contentView registerClass:[MHHorizontalMode0Cell class] forCellWithReuseIdentifier:NSStringFromClass(MHHorizontalMode0Cell.class)];
}
