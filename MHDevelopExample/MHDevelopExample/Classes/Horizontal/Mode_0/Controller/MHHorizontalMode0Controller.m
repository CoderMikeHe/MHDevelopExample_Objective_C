//
//  MHHorizontalMode0Controller.m
//  MHObjectiveC
//
//  Created by CoderMikeHe on 2018/12/14.
//  Copyright © 2018年 CoderMikeHe. All rights reserved.
//  方案一 ： 9个黑块 == 1个Cell，UIPageControl不支持联动
...
@interface MHHorizontalMode0Controller ()<UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate,MHHorizontalCellDelegate>
/// backgroundView
...
@implementation MHHorizontalMode0Controller
...
- (void)_setPageContentViewWithCurrentIndex:(NSInteger)currentIndex{
    ...
    self.pageControl.numberOfPages = [self.horizontalGroupPageCounts[currentIndex] integerValue];
}
